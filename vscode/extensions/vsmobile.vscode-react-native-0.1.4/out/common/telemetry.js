...
(function (Telemetry) {
    ...
    var TelemetryUtils = (function () {
        ...
        TelemetryUtils.init = function (appVersion, initOptions) {
    ...
    var ExtensionTelemetryReporter = (function () {
        function ExtensionTelemetryReporter(extensionId, extensionVersion, key) {
            this.extensionId = extensionId;
            this.extensionVersion = extensionVersion;
            this.appInsightsKey = key;
            this.extensionMessageSender = new extensionMessaging_1.ExtensionMessageSender();
        }
