...
var Packager = (function () {
    ...
    Packager.prototype.start = function () {
        var _this = this;
        ...
        return this.isRunning()
            ...
            if (!running) {
                ...
                return _this.monkeyPatchOpnForRNPackager()
                    ...
                    var spawnOptions = { env: childEnvForDebugging };
    ...
    Packager.prototype.stop = function () {
        ...
        return this.isRunning()
            ...
            if (running) {
                ...
                return new commandExecutor_1.CommandExecutor(_this.projectPath).killReactPackager(_this.packagerProcess).then(function () {
                    return _this.packagerProcess = null;
                });
            }
            else {
    ...
    Packager.prototype.prewarmBundleCache = function (platform) {
        var bundleURL = "http://" + Packager.HOST + "/index." + platform + ".bundle";
    ...
    Packager.prototype.isRunning = function () {
        var statusURL = "http://" + Packager.HOST + "/status";
    ...
    Packager.PORT = "8081";
    Packager.HOST = "localhost:" + Packager.PORT;
