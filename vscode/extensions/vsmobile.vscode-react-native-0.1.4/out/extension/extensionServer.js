...
var ExtensionServer = (function () {
    function ExtensionServer(reactNativePackager, packagerStatusIndicator) {
        this.serverInstance = null;
        this.messageHandlerDictionary = {};
        this.logCatMonitor = null;
        this.pipePath = hostPlatform_1.HostPlatform.getExtensionPipePath();
    ...
    ExtensionServer.prototype.setup = function () {
        ...
        var launchCallback = function (error) {
            log_1.Log.logInternalMessage(logHelper_1.LogLevel.Info, "Extension messaging server started.");
            if (error) {
     ...
     */
    ExtensionServer.prototype.startPackager = function () {
        var _this = this;
