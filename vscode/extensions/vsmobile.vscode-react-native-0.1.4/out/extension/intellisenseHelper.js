...
var IntellisenseHelper = (function () {
    ...
    IntellisenseHelper.configureWorkspaceSettings = function (isRestartRequired) {
        ...
        return settingsHelper_1.SettingsHelper.getTypeScriptTsdk()
            .then(function (tsdkPath) {
            if (IntellisenseHelper.isSalsaSupported()) {
                if (tsdkPath !== null &&
                    ...
                    return settingsHelper_1.SettingsHelper.removeTypeScriptTsdk()
                        .then(function () { return true; });
                }
            }
            else {
                if (tsdkPath === null) {
                    return settingsHelper_1.SettingsHelper.setTypeScriptTsdk(typeScriptLibPath)
                        .then(function () { return true; });
                }
            }
            return isRestartRequired;
